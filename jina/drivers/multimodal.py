...
class MultiModalDriver(BaseEncodeDriver):
    ...
    def _get_executor_input_arguments(self, content_by_modality: Dict[str, 'np.ndarray']):
        ...
        """
        return [content_by_modality[modality] for modality in self.position_modality]
    ...
    def _apply_all(
        ...
        for doc in docs:
            ...
            if doc_content:
                ...
                for modality in self.position_modality:
