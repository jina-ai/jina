...
🧩**Мощные расширения, простая интеграция** - Требуется новая ИИ-модель для Jina? Просто напишите сценарий на Python или создайте Docker образ. Подключение новых алгоритмов никогда еще не было таким простым. [Оцените Jina Hub (бета)](https://github.com/jina-ai/jina-hub) и найти больше расширений для различных задач, созданных сообществом.
...
- [Jina "Привет, мир!" 👋🌍](#%D0%B4%D0%B6%D0%B8%D0%BD%D0%B0-%D0%BF%D1%80%D0%B8%D0%B2%D0%B5%D1%82-%D0%BC%D0%B8%D1%80-)
...
В для начала приглашаем вас попробовать "Привет, мир" Jina - простую демо-версию нейросетевого поиска изображений для [Fashion-MNIST](https://hanxiao.io/2018/09/28/Fashion-MNIST-Year-In-Review/). Никаких дополнительных зависимостей не нужно, просто сделай:
