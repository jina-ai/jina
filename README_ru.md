...
**🚀 Высокий преформат и состояние искусства** - Jina нацелена на ИИ в производстве. Вы можете легко масштабировать VideoBERT, Xception, ваш токенайзер слова, сегментатор изображения и базы данных для обработки данных на миллиардном уровне. Такие функции, как реплики и осколки, доступны с полки.
...
Чтобы установить Jina с дополнительными зависимостями, или установить его на Raspberry Pi, пожалуйста, обратитесь к документации.
...
<details>
<summary>Нажмите здесь, чтобы увидеть вывод консоли</summary>
...
<tr>
<td>
<h4><a href="https://github.com/jina-ai/examples/tree/master/southpark-search">Постройте систему семантического поиска NLP на базе BERT за 3 минуты</a></h4>
Узнайте, как использовать Jina и DistilBert для построения системы поиска сленга
</td>
<td><h3>🐣</h3></td>
</tr>
...
<tr>
<td>
<h4><a href="https://github.com/jina-ai/examples/tree/master/flower-search">Построить систему поиска изображений цветов за 3 минуты</a></h4>
Узнайте, как использовать Jina и Torchvision для построения системы поиска изображений цветов
</td>
<td><h3>🐣</h3></td>
</tr>
...
Ты звезда Док? Тогда присоединяйся к нам! Мы приветствуем всевозможные улучшения в документации. 
