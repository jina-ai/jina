...
def test_only_root(documentset):
    documentset.traverse(['r'], callback_fn)
    assert len(documentset) == 1
    assert len(documentset[0].chunks) == 2
    assert len(documentset[0].chunks[0].chunks) == 1
    # assert len(documentset[0].chunks[0].chunks[0].matches) == 1
    # assert len(documentset[0].chunks[0].matches) == 1
    # assert len(documentset[0].matches) == 3
