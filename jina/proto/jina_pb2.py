...
_MESSAGELISTPROTO = _descriptor.Descriptor(
  ...
  full_name='jina.MessageListProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='messages', full_name='jina.MessageListProto.messages', index=0,
...
_MESSAGELISTPROTO.fields_by_name['messages'].message_type = _MESSAGEPROTO
