...
_NDARRAY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='raw_bytes', full_name='jina.NdArray.raw_bytes', index=0,
...
_CHUNK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='raw_bytes', full_name='jina.Chunk.raw_bytes', index=4,
...
_DOCUMENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='raw_bytes', full_name='jina.Document.raw_bytes', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chunks', full_name='jina.Document.chunks', index=2,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weight', full_name='jina.Document.weight', index=3,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='length', full_name='jina.Document.length', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='meta_info', full_name='jina.Document.meta_info', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='topk_results', full_name='jina.Document.topk_results', index=6,
...
_ENVELOPE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='client_id', full_name='jina.Envelope.client_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='request_id', full_name='jina.Envelope.request_id', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='jina.Envelope.timeout', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='routes', full_name='jina.Envelope.routes', index=3,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='jina.Envelope.version', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status', full_name='jina.Envelope.status', index=5,
...
_SPAWNREQUEST_FLOWPODSPAWNREQUEST = _descriptor.Descriptor(
  name='FlowPodSpawnRequest',
  full_name='jina.SpawnRequest.FlowPodSpawnRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='head', full_name='jina.SpawnRequest.FlowPodSpawnRequest.head', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tail', full_name='jina.SpawnRequest.FlowPodSpawnRequest.tail', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='peas', full_name='jina.SpawnRequest.FlowPodSpawnRequest.peas', index=2,
...
_SPAWNREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flow_pod', full_name='jina.SpawnRequest.flow_pod', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='logs', full_name='jina.SpawnRequest.logs', index=3,
  ...
  nested_types=[_SPAWNREQUEST_PEASPAWNREQUEST, _SPAWNREQUEST_PODSPAWNREQUEST, _SPAWNREQUEST_FLOWPODSPAWNREQUEST, ],
  enum_types=[
...
_CHUNK.oneofs_by_name['content'].fields.append(
  _CHUNK.fields_by_name['raw_bytes'])
_CHUNK.fields_by_name['raw_bytes'].containing_oneof = _CHUNK.oneofs_by_name['content']
...
_SPAWNREQUEST_FLOWPODSPAWNREQUEST.fields_by_name['head'].message_type = _SPAWNREQUEST_PEASPAWNREQUEST
_SPAWNREQUEST_FLOWPODSPAWNREQUEST.fields_by_name['tail'].message_type = _SPAWNREQUEST_PEASPAWNREQUEST
_SPAWNREQUEST_FLOWPODSPAWNREQUEST.fields_by_name['peas'].message_type = _SPAWNREQUEST_PEASPAWNREQUEST
_SPAWNREQUEST_FLOWPODSPAWNREQUEST.containing_type = _SPAWNREQUEST
...
_SPAWNREQUEST.fields_by_name['flow_pod'].message_type = _SPAWNREQUEST_FLOWPODSPAWNREQUEST
...
_SPAWNREQUEST.oneofs_by_name['body'].fields.append(
  _SPAWNREQUEST.fields_by_name['flow_pod'])
_SPAWNREQUEST.fields_by_name['flow_pod'].containing_oneof = _SPAWNREQUEST.oneofs_by_name['body']
...
SpawnRequest = _reflection.GeneratedProtocolMessageType('SpawnRequest', (_message.Message,), {
  ...
  'FlowPodSpawnRequest' : _reflection.GeneratedProtocolMessageType('FlowPodSpawnRequest', (_message.Message,), {
    'DESCRIPTOR' : _SPAWNREQUEST_FLOWPODSPAWNREQUEST,
    '__module__' : 'jina_pb2'
    # @@protoc_insertion_point(class_scope:jina.SpawnRequest.FlowPodSpawnRequest)
    })
  ,
...
_sym_db.RegisterMessage(SpawnRequest.FlowPodSpawnRequest)
