...
from jina.executors.evaluators.recall import RecallEvaluator
...
def test_recall_evaluator_eval_at_0():
    def matches():
        match0 = jina_pb2.Document()
        match0.tags['id'] = 0
        match1 = jina_pb2.Document()
    ...
    evaluator = RecallEvaluator(eval_at=0, id_tag='id')
    assert evaluator.evaluate(matches=matches(), groundtruth=groundtruth()) == 0.0
