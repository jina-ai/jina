...
_GRAPHRELATEDINFOPROTO = _descriptor.Descriptor(
  name='GraphRelatedInfoProto',
  full_name='jina.GraphRelatedInfoProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='adjacency', full_name='jina.GraphRelatedInfoProto.adjacency', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='edge_features', full_name='jina.GraphRelatedInfoProto.edge_features', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GRAPHRELATEDINFOPROTO.fields_by_name['adjacency'].message_type = _SPARSENDARRAYPROTO
_GRAPHRELATEDINFOPROTO.fields_by_name['edge_features'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
...
_DOCUMENTPROTO.fields_by_name['graph_info'].message_type = _GRAPHRELATEDINFOPROTO
...
DESCRIPTOR.message_types_by_name['GraphRelatedInfoProto'] = _GRAPHRELATEDINFOPROTO
...
GraphRelatedInfoProto = _reflection.GeneratedProtocolMessageType('GraphRelatedInfoProto', (_message.Message,), {
  'DESCRIPTOR' : _GRAPHRELATEDINFOPROTO,
  '__module__' : 'jina_pb2'
  # @@protoc_insertion_point(class_scope:jina.GraphRelatedInfoProto)
  })
_sym_db.RegisterMessage(GraphRelatedInfoProto)
