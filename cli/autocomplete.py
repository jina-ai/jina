...
ac_table = {
    'commands': ['--help', '--version', '--version-full', 'hello', 'pod', 'flow', 'optimizer', 'gateway', 'ping',
                 'check', 'hub', 'pea', 'client', 'export-api'], 'completions': {
        ...
        'flow': ['--help', '--name', '--description', '--workspace', '--log-config', '--quiet', '--quiet-error',
                 '--identity', '--uses', '--inspect'],
        'optimizer': ['--help', '--name', '--description', '--workspace', '--log-config', '--quiet', '--quiet-error',
                      '--identity', '--uses', '--output-dir'],
        ...
        'hub build': ['--help', '--username', '--password', '--registry', '--repository', '--file', '--pull', '--push',
