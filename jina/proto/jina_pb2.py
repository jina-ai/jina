...
_ENVELOPE_COMPRESSALGO = _descriptor.EnumDescriptor(
  name='CompressAlgo',
  full_name='jina.Envelope.CompressAlgo',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_ENVELOPE_COMPRESSALGO)
...
_ENVELOPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='compress', full_name='jina.Envelope.compress', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_data_request', full_name='jina.Envelope.is_data_request', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='check_version', full_name='jina.Envelope.check_version', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='request_type', full_name='jina.Envelope.request_type', index=11,
...
_ENVELOPE.fields_by_name['compress'].enum_type = _ENVELOPE_COMPRESSALGO
_ENVELOPE_COMPRESSALGO.containing_type = _ENVELOPE
