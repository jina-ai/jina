...
**Jina** is cloud-native neural search, powered by the state-of-the-art AI and deep learning. It has **long-term support** from a full-time, [venture-backed team](https://jina.ai).
...
Are you a "Doc"-star? [Join us!](#join-us) We welcome all kinds of improvements on the documentation.
