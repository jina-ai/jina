...
class Flow(
    ...
    def add(
        ...
        **kwargs) -> Union['Flow', 'AsyncFlow']:
        ...
        :param protocol: Communication protocol of the server exposed by the Executor. This can be a single value or a list of protocols. Choose the convenient protocols from: ['GRPC', 'HTTP'].
        ...
        :param ssl_certfile: the path to the certificate file if using HTTP protocol
        :param ssl_keyfile: the path to the key file if using HTTP protocol
        :param timeout_ctrl: The timeout in milliseconds of the control request, -1 for waiting forever
        :param timeout_ready: The timeout in milliseconds of a Pod waits for the runtime to be ready, -1 for waiting forever
        :param timeout_send: The timeout in milliseconds used when sending data requests to Executors, -1 means no timeout, disabled by default
