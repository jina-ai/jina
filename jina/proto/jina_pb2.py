...
_REQUESTPROTO_RECONNECTPODREQUESTPROTO = _descriptor.Descriptor(
  name='ReconnectPodRequestProto',
  full_name='jina.RequestProto.ReconnectPodRequestProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='pod_and_out_port', full_name='jina.RequestProto.ReconnectPodRequestProto.pod_and_out_port', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REQUESTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reconnectpod', full_name='jina.RequestProto.reconnectpod', index=7,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_REQUESTPROTO_TRAINREQUESTPROTO, _REQUESTPROTO_INDEXREQUESTPROTO, _REQUESTPROTO_UPDATEREQUESTPROTO, _REQUESTPROTO_DELETEREQUESTPROTO, _REQUESTPROTO_RECONNECTPODREQUESTPROTO, _REQUESTPROTO_SEARCHREQUESTPROTO, _REQUESTPROTO_CONTROLREQUESTPROTO, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_REQUESTPROTO_RECONNECTPODREQUESTPROTO.containing_type = _REQUESTPROTO
...
_REQUESTPROTO.fields_by_name['reconnectpod'].message_type = _REQUESTPROTO_RECONNECTPODREQUESTPROTO
...
_REQUESTPROTO.oneofs_by_name['body'].fields.append(
  _REQUESTPROTO.fields_by_name['reconnectpod'])
_REQUESTPROTO.fields_by_name['reconnectpod'].containing_oneof = _REQUESTPROTO.oneofs_by_name['body']
...
RequestProto = _reflection.GeneratedProtocolMessageType('RequestProto', (_message.Message,), {
  ...
  'ReconnectPodRequestProto' : _reflection.GeneratedProtocolMessageType('ReconnectPodRequestProto', (_message.Message,), {
    'DESCRIPTOR' : _REQUESTPROTO_RECONNECTPODREQUESTPROTO,
    '__module__' : 'jina_pb2'
    # @@protoc_insertion_point(class_scope:jina.RequestProto.ReconnectPodRequestProto)
    })
  ,
...
_sym_db.RegisterMessage(RequestProto.ReconnectPodRequestProto)
