...
class HeadRuntime(AsyncNewLoopRuntime, ABC):
    ...
    async def _handle_data_request(
        ...
        ExecutorRequestHandler.merge_routes(requests)
        ...
        if self.uses_after_address:
            ...
            ExecutorRequestHandler.reduce_requests(worker_results)
            ...
            response_request.data.docs = ExecutorRequestHandler.get_docs_from_request(
                requests, field='docs'
            )
