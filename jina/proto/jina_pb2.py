...
_ENVELOPE_STATUS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PAUSE_POLLING', index=4, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RESUME_POLLING', index=5, number=5,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
