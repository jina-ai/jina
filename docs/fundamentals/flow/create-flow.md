...
You can control the access mode, the storage class name and the capacity of the attached Persistent Volume Claim by using the {ref}`Jina envirionemnt variables <jina-env-vars>`  
