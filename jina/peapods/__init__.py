...
def Pea(args: 'argparse.Namespace' = None, allow_remote: bool = True, **kwargs) -> 'BasePea':
...
def Pod(args: Union['argparse.Namespace', Dict] = None, allow_remote: bool = True, **kwargs) -> 'BasePod':
