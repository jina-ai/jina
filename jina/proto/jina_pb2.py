...
_REQUESTPROTO_ENDTRAININGREQUESTPROTO = _descriptor.Descriptor(
  name='EndTrainingRequestProto',
  full_name='jina.RequestProto.EndTrainingRequestProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='path', full_name='jina.RequestProto.EndTrainingRequestProto.path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REQUESTPROTO_RELOADFROMTRAININGREQUESTPROTO = _descriptor.Descriptor(
  name='ReloadFromTrainingRequestProto',
  full_name='jina.RequestProto.ReloadFromTrainingRequestProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='path', full_name='jina.RequestProto.ReloadFromTrainingRequestProto.path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REQUESTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='endtraining', full_name='jina.RequestProto.endtraining', index=7,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reloadfromtraining', full_name='jina.RequestProto.reloadfromtraining', index=8,
      number=12, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='jina.RequestProto.status', index=9,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='routes', full_name='jina.RequestProto.routes', index=10,
      number=8, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='queryset', full_name='jina.RequestProto.queryset', index=11,
  ...
  nested_types=[_REQUESTPROTO_ENDTRAININGREQUESTPROTO, _REQUESTPROTO_RELOADFROMTRAININGREQUESTPROTO, _REQUESTPROTO_TRAINREQUESTPROTO, _REQUESTPROTO_INDEXREQUESTPROTO, _REQUESTPROTO_UPDATEREQUESTPROTO, _REQUESTPROTO_DELETEREQUESTPROTO, _REQUESTPROTO_SEARCHREQUESTPROTO, _REQUESTPROTO_CONTROLREQUESTPROTO, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_REQUESTPROTO_ENDTRAININGREQUESTPROTO.containing_type = _REQUESTPROTO
_REQUESTPROTO_RELOADFROMTRAININGREQUESTPROTO.containing_type = _REQUESTPROTO
...
_REQUESTPROTO.fields_by_name['endtraining'].message_type = _REQUESTPROTO_ENDTRAININGREQUESTPROTO
_REQUESTPROTO.fields_by_name['reloadfromtraining'].message_type = _REQUESTPROTO_RELOADFROMTRAININGREQUESTPROTO
...
_REQUESTPROTO.oneofs_by_name['body'].fields.append(
  _REQUESTPROTO.fields_by_name['endtraining'])
_REQUESTPROTO.fields_by_name['endtraining'].containing_oneof = _REQUESTPROTO.oneofs_by_name['body']
_REQUESTPROTO.oneofs_by_name['body'].fields.append(
  _REQUESTPROTO.fields_by_name['reloadfromtraining'])
_REQUESTPROTO.fields_by_name['reloadfromtraining'].containing_oneof = _REQUESTPROTO.oneofs_by_name['body']
...
RequestProto = _reflection.GeneratedProtocolMessageType('RequestProto', (_message.Message,), {
  ...
  'EndTrainingRequestProto' : _reflection.GeneratedProtocolMessageType('EndTrainingRequestProto', (_message.Message,), {
    'DESCRIPTOR' : _REQUESTPROTO_ENDTRAININGREQUESTPROTO,
    '__module__' : 'jina_pb2'
    # @@protoc_insertion_point(class_scope:jina.RequestProto.EndTrainingRequestProto)
    })
  ,

  'ReloadFromTrainingRequestProto' : _reflection.GeneratedProtocolMessageType('ReloadFromTrainingRequestProto', (_message.Message,), {
    'DESCRIPTOR' : _REQUESTPROTO_RELOADFROMTRAININGREQUESTPROTO,
    '__module__' : 'jina_pb2'
    # @@protoc_insertion_point(class_scope:jina.RequestProto.ReloadFromTrainingRequestProto)
    })
  ,
...
_sym_db.RegisterMessage(RequestProto.EndTrainingRequestProto)
_sym_db.RegisterMessage(RequestProto.ReloadFromTrainingRequestProto)
