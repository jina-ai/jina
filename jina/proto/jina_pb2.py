...
_SPAWNREQUEST_PODDICTSPAWNREQUEST = _descriptor.Descriptor(
  name='PodDictSpawnRequest',
  full_name='jina.SpawnRequest.PodDictSpawnRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='head', full_name='jina.SpawnRequest.PodDictSpawnRequest.head', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tail', full_name='jina.SpawnRequest.PodDictSpawnRequest.tail', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='peas', full_name='jina.SpawnRequest.PodDictSpawnRequest.peas', index=2,
...
_SPAWNREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cust_pod', full_name='jina.SpawnRequest.cust_pod', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_SPAWNREQUEST_PEASPAWNREQUEST, _SPAWNREQUEST_PODSPAWNREQUEST, _SPAWNREQUEST_PODDICTSPAWNREQUEST, ],
  enum_types=[
...
_SPAWNREQUEST_PODDICTSPAWNREQUEST.fields_by_name['head'].message_type = _SPAWNREQUEST_PEASPAWNREQUEST
_SPAWNREQUEST_PODDICTSPAWNREQUEST.fields_by_name['tail'].message_type = _SPAWNREQUEST_PEASPAWNREQUEST
_SPAWNREQUEST_PODDICTSPAWNREQUEST.fields_by_name['peas'].message_type = _SPAWNREQUEST_PEASPAWNREQUEST
_SPAWNREQUEST_PODDICTSPAWNREQUEST.containing_type = _SPAWNREQUEST
...
_SPAWNREQUEST.fields_by_name['cust_pod'].message_type = _SPAWNREQUEST_PODDICTSPAWNREQUEST
...
_SPAWNREQUEST.oneofs_by_name['body'].fields.append(
  _SPAWNREQUEST.fields_by_name['cust_pod'])
_SPAWNREQUEST.fields_by_name['cust_pod'].containing_oneof = _SPAWNREQUEST.oneofs_by_name['body']
...
SpawnRequest = _reflection.GeneratedProtocolMessageType('SpawnRequest', (_message.Message,), {
  ...
  'PodDictSpawnRequest': _reflection.GeneratedProtocolMessageType('PodDictSpawnRequest', (_message.Message,), {
    'DESCRIPTOR': _SPAWNREQUEST_PODDICTSPAWNREQUEST,
    '__module__': 'jina_pb2'
    # @@protoc_insertion_point(class_scope:jina.SpawnRequest.PodDictSpawnRequest)
  })
  ,
...
_sym_db.RegisterMessage(SpawnRequest.PodDictSpawnRequest)
