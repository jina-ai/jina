...
_DOCUMENTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='graph_info', full_name='jina.DocumentProto.graph_info', index=9,
...
_DOCUMENTPROTO.oneofs_by_name['content'].fields.append(
  _DOCUMENTPROTO.fields_by_name['graph_info'])
_DOCUMENTPROTO.fields_by_name['graph_info'].containing_oneof = _DOCUMENTPROTO.oneofs_by_name['content']
