...
If you're not yet familiar with these concepts, first read the [Executor](../fundamentals/executor) and [Flow](../fundamentals/executor) documentation, and return to this tutorial once you feel comfortable performing basic operations in Jina.
```
