...
_REQUESTPROTO_INDEXREQUESTPROTO_METHOD = _descriptor.EnumDescriptor(
  name='Method',
  full_name='jina.RequestProto.IndexRequestProto.Method',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_REQUESTPROTO_INDEXREQUESTPROTO_METHOD)
...
_REQUESTPROTO_INDEXREQUESTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='method', full_name='jina.RequestProto.IndexRequestProto.method', index=2,
  ...
  nested_types=[],
  enum_types=[
    _REQUESTPROTO_INDEXREQUESTPROTO_METHOD,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_REQUESTPROTO_INDEXREQUESTPROTO.fields_by_name['method'].enum_type = _REQUESTPROTO_INDEXREQUESTPROTO_METHOD
_REQUESTPROTO_INDEXREQUESTPROTO.containing_type = _REQUESTPROTO
_REQUESTPROTO_INDEXREQUESTPROTO_METHOD.containing_type = _REQUESTPROTO_INDEXREQUESTPROTO
