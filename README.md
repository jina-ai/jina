...
TODO: Adapt image to docarray >= 0.30
...
class StableLM(Executor):
    ...
    def generate(self, docs: DocList[Prompt], **kwargs) -> DocList[Generation]:
        ...
        prompts = docs.texts
        llm_ouptuts = self.generator(prompts)
        for prompt, output in zip(prompts, llm_ouptuts):
...
TODO: This is not going to work, avoid reusing from Executor Hub
