...
c = Client(protocol='grpc', port_gateway=12345)
c.post('/', Document())
```
...
c = Client(host='192.168.1.15', port_gateway=12345)
...
c = Client(protocol='websocket', host='192.168.1.15', port_gateway=12345)
c.post('/')
```
...
c = Client(protocol='http', port_gateway=12345)
c.post('/', ...)
```
