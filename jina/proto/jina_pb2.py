...
_REQUESTPROTO_RELOADREQUESTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='workspace', full_name='jina.RequestProto.ReloadRequestProto.workspace', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REQUESTPROTO_DUMPREQUESTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='path', full_name='jina.RequestProto.DumpRequestProto.path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='shards', full_name='jina.RequestProto.DumpRequestProto.shards', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='formats', full_name='jina.RequestProto.DumpRequestProto.formats', index=2,
...
_REQUESTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dump', full_name='jina.RequestProto.dump', index=8,
      number=12, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_REQUESTPROTO_TRAINREQUESTPROTO, _REQUESTPROTO_INDEXREQUESTPROTO, _REQUESTPROTO_UPDATEREQUESTPROTO, _REQUESTPROTO_DELETEREQUESTPROTO, _REQUESTPROTO_SEARCHREQUESTPROTO, _REQUESTPROTO_RELOADREQUESTPROTO, _REQUESTPROTO_DUMPREQUESTPROTO, _REQUESTPROTO_CONTROLREQUESTPROTO, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_REQUESTPROTO_DUMPREQUESTPROTO.fields_by_name['formats'].enum_type = _REQUESTPROTO_DUMPREQUESTPROTO_DUMPTYPES
_REQUESTPROTO_DUMPREQUESTPROTO.containing_type = _REQUESTPROTO
_REQUESTPROTO_DUMPREQUESTPROTO_DUMPTYPES.containing_type = _REQUESTPROTO_DUMPREQUESTPROTO
...
_REQUESTPROTO.oneofs_by_name['body'].fields.append(
  _REQUESTPROTO.fields_by_name['dump'])
_REQUESTPROTO.fields_by_name['dump'].containing_oneof = _REQUESTPROTO.oneofs_by_name['body']
...
RequestProto = _reflection.GeneratedProtocolMessageType('RequestProto', (_message.Message,), {
  ...
  'DumpRequestProto' : _reflection.GeneratedProtocolMessageType('DumpRequestProto', (_message.Message,), {
