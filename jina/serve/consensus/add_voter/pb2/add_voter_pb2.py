...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x0f\x61\x64\x64_voter.proto\x12\tadd_voter\"-\n\rAwaitResponse\x12\r\n\x05\x65rror\x18\x01 \x01(\t\x12\r\n\x05index\x18\x02 \x01(\x04\"\x10\n\x0e\x46orgetResponse\"!\n\x06\x46uture\x12\x17\n\x0foperation_token\x18\x01 \x01(\t\"F\n\x0f\x41\x64\x64VoterRequest\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0f\n\x07\x61\x64\x64ress\x18\x02 \x01(\t\x12\x16\n\x0eprevious_index\x18\x03 \x01(\x04\x32\xba\x01\n\tRaftAdmin\x12;\n\x08\x41\x64\x64Voter\x12\x1a.add_voter.AddVoterRequest\x1a\x11.add_voter.Future\"\x00\x12\x36\n\x05\x41wait\x12\x11.add_voter.Future\x1a\x18.add_voter.AwaitResponse\"\x00\x12\x38\n\x06\x46orget\x12\x11.add_voter.Future\x1a\x19.add_voter.ForgetResponse\"\x00\x62\x06proto3')
...
AwaitResponse = _reflection.GeneratedProtocolMessageType('AwaitResponse', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:add_voter.AwaitResponse)
  })
...
ForgetResponse = _reflection.GeneratedProtocolMessageType('ForgetResponse', (_message.Message,), {
  ...
  '__module__' : 'add_voter_pb2'
  # @@protoc_insertion_point(class_scope:add_voter.ForgetResponse)
  })
...
Future = _reflection.GeneratedProtocolMessageType('Future', (_message.Message,), {
  'DESCRIPTOR' : _FUTURE,
  '__module__' : 'add_voter_pb2'
  # @@protoc_insertion_point(class_scope:add_voter.Future)
  })
...
AddVoterRequest = _reflection.GeneratedProtocolMessageType('AddVoterRequest', (_message.Message,), {
  ...
  '__module__' : 'add_voter_pb2'
  # @@protoc_insertion_point(class_scope:add_voter.AddVoterRequest)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _AWAITRESPONSE._serialized_start=30
  _AWAITRESPONSE._serialized_end=75
  _FORGETRESPONSE._serialized_start=77
  _FORGETRESPONSE._serialized_end=93
  _FUTURE._serialized_start=95
  _FUTURE._serialized_end=128
  _ADDVOTERREQUEST._serialized_start=130
  _ADDVOTERREQUEST._serialized_end=200
  _RAFTADMIN._serialized_start=203
  _RAFTADMIN._serialized_end=389
