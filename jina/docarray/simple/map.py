...
class ScoreMapView(BaseProtoType, MutableMapping):
    """
    :class:`NamedScoreMapping` is one of the **primitive data type** in Jina.

    It offers a Pythonic interface to allow users access and manipulate
    :class:`jina.docarray_pb2.NamedScoreMappingProto` object without working with Protobuf itself.
    ...
    _PbType = MessageMapContainer

    def __setitem__(
        self,
        key: str,
        value: Union[NamedScoreProto, ScoreView, float, np.generic],
    ):
    ...
    def __getitem__(
        ...
        return ScoreView(self._pb_body[key])
