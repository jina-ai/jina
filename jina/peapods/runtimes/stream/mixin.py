...
class StreamMixin(ABC):
    """Mixin for streaming methods"""
    ...
    def handle_request(self, request: 'Request') -> 'asyncio.Future':
        """Defines how the request is processed
    ...
    def handle_response(self, response: 'Response') -> None:
        """Defines how the response is processed
    ...
    def handle_end_of_iter(self):
        """Manage end of iteration for requests"""
        ...
