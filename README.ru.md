...
🐣**Системный инжиниринг стал простым** - Jina предлагает универсальное решение, которое освобождает вас от ручной работы и склеивания пакетов, библиотек и баз данных[С наиболее интуитивно понятным API и пользовательским интерфейсом приборной панели](https://github.com/jina-ai/dashboard)построить облачную поисковую систему - это всего лишь минута.
...
Джина - проект с открытым исходным кодом[Мы нанимаем](https://jina.ai/jobs) Инженеры по ИИ, разработчики полного стека, евангелисты, ПМ для построения следующей нейронной поисковой эко-системы с открытым исходным кодом
...
-   [Установить](#install)
-   [Джина "Привет, мир!" 👋🌍](#jina-hello-world-)
...
[Убедитесь в том, что вы продолжаете пользоваться нашим гидом Jina 101](https://github.com/jina-ai/jina#jina-101-first-thing-to-learn-about-jina) - понимание всех ключевых понятий Джины за 3 минуты!  
