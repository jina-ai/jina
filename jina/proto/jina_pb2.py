...
_GRAPH = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='adjacency', full_name='jina.Graph.adjacency', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='edge_features', full_name='jina.Graph.edge_features', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GRAPH.fields_by_name['adjacency'].message_type = _SPARSENDARRAYPROTO
_GRAPH.fields_by_name['edge_features'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
...
_DOCUMENTPROTO.fields_by_name['graph_info'].message_type = _GRAPH
...
Graph = _reflection.GeneratedProtocolMessageType('Graph', (_message.Message,), {
  'DESCRIPTOR' : _GRAPH,
  '__module__' : 'jina_pb2'
  # @@protoc_insertion_point(class_scope:jina.Graph)
  })
