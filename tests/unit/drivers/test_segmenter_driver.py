...
def test_segment_driver():
    ...
    assert valid_doc.chunks[0].siblings == 3
    ...
    assert valid_doc.chunks[1].siblings == 3
    ...
    assert valid_doc.chunks[2].siblings == 3
...
def test_broken_document():
    ...
    invalid_doc.siblings = 2

    assert invalid_doc.siblings == 2
