...
def test_message_docs_different_chunk_types(input_doc_with_chunks, mocker):
    ...
    with Flow().add() as f:
        f.search(input_fn=[input_doc_with_chunks], output_fn=response_mock)
...
def test_message_docs_different_matches_types(input_doc_with_matches, mocker):
    ...
    with Flow().add() as f:
        f.search(input_fn=[input_doc_with_matches], output_fn=response_mock)
...
def test_message_docs_different_chunks_and_matches_types(input_doc_chunks_and_matches, mocker):
    ...
    with Flow().add() as f:
        f.search(input_fn=[input_doc_chunks_and_matches], output_fn=response_mock)
