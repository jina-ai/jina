...
from ..types.lists import ChunkList, MatchList, DocumentList
...
class ConcatEmbedDriver(BaseRecursiveDriver):
    ...
    def _collect_embeddings(self, docs: 'DocumentList'):
