...
_REQUEST_EVALREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='groundtruths', full_name='jina.Request.EvalRequest.groundtruths', index=1,
...
_REQUEST_EVALREQUEST.fields_by_name['groundtruths'].message_type = _DOCUMENT
