...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| docs | [docarray.DocumentProto](#docarray.DocumentProto) | repeated | a list of Documents to query |
| groundtruths | [docarray.DocumentProto](#docarray.DocumentProto) | repeated | a list of groundtruth Document you want to evaluate it with |
