...
from typing import Callable, Any, Union, Iterator, List, Optional, Dict, Iterable, Sequence
    ...
    class FunctionMapper:
        def __init__(self, fn):
            ...
            if not arg_spec.varkw and len(arg_spec.args) < __num_args_executor_func__:
                raise TypeError(f'{fn} accepts only {arg_spec.args} which is fewer than expected, '
