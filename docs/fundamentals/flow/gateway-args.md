...
| `protocol` | Possible communication protocols between server and client. Choose any list combination of the following choices: ['grpc', 'http', 'websocket']. | `array` | `grpc` |
