...
def test_json_formatter():
    ...
    record = LogRecord(name='record', level='level', pathname='pathname', lineno=1, msg='text message', args=None,
                    exc_info=None)
...
def test_profile_formatter(msg):
    ...
    record = LogRecord(name='record', level='level', pathname='pathname', lineno=1, msg=msg, args=None,
                        exc_info=None)
